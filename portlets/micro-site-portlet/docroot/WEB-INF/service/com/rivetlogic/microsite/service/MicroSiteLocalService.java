...
/**
 * Provides the local service interface for MicroSite. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author steven.barba
 * @see MicroSiteLocalServiceUtil
...
public interface MicroSiteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MicroSiteLocalServiceUtil} to access the micro site local service. Add custom service methods to {@link com.rivetlogic.microsite.service.impl.MicroSiteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
