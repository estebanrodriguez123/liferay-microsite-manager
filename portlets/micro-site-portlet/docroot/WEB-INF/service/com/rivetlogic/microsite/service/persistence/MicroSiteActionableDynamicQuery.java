 ...
 * @generated
 */
public abstract class MicroSiteActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MicroSiteActionableDynamicQuery() throws SystemException {
		setBaseLocalService(MicroSiteLocalServiceUtil.getService());
		setClass(MicroSite.class);

		setClassLoader(com.rivetlogic.microsite.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("microSiteId");
	}
}