...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"micro-site-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "micro-site-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(MicroSiteClp.class.getName())) {
	...
	public static Object translateInputMicroSite(BaseModel<?> oldModel) {
	...
	public static Object translateOutputMicroSite(BaseModel<?> oldModel) {
		MicroSiteClp newModel = new MicroSiteClp();
